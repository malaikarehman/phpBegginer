<nav class="bg-gray-800">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <a href="/content" class=" <?=  urlIS('/content') ?" bg-gray-900 text-white ": "text-gray-300 "; ?>   hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Content</a>
