    ...
    <div class="hidden lg:flex lg:gap-x-12">
      <div class="relative">
        ...
        <div class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
          <div class="p-4">
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6    <?= uriIS('/analytics')? 'bg-gray-50':'leading-6'; ?>  ">
              <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50      <?= uriIS('/analytics')? 'bg-white':'bg-gray-50';  ?>  ">
                <svg class="h-6 w-6 text-gray-600     <?= uriIS('/analytics')? 'text-indigo-600':'text-gray-600';  ?>"      fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />
                  <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z" />
                </svg>
              </div>
              <div class="flex-auto">
                <a href="/analytics" class="block font-semibold text-gray-900">
                  Analytics
            ...
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6      <?= uriIS('/security')? 'bg-gray-50':'leading-6'; ?>  ">
              <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50      <?= uriIS('/security')? 'bg-white':'bg-gray-50';  ?>">
                <svg class="h-6 w-6 text-gray-600         <?= uriIS('/security')? 'text-indigo-600':'text-gray-600';  ?>             " fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 004.5 10.5a7.464 7.464 0 01-1.15 3.993m1.989 3.559A11.209 11.209 0 008.25 10.5a3.75 3.75 0 117.5 0c0 .527-.021 1.049-.064 1.565M12 10.5a14.94 14.94 0 01-3.6 9.75m6.633-4.596a18.666 18.666 0 01-2.485 5.33" />
                </svg>
              </div>
              <div class="flex-auto">
                <a href="/security" class="block font-semibold text-gray-900">
                  Security
                  <span class="absolute inset-0"></span>
                </a>
            ...
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6          <?= uriIS('/integration')? 'bg-gray-50':'leading-6'; ?>">
              <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50       <?= uriIS('/integration')? 'bg-white':'bg-gray-50';  ?>">
                <svg class="h-6 w-6 text-gray-600        <?= uriIS('/integration')? 'text-indigo-600':'text-gray-600';  ?>       " fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 16.875h3.375m0 0h3.375m-3.375 0V13.5m0 3.375v3.375M6 10.5h2.25a2.25 2.25 0 002.25-2.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v2.25A2.25 2.25 0 006 10.5zm0 9.75h2.25A2.25 2.25 0 0010.5 18v-2.25a2.25 2.25 0 00-2.25-2.25H6a2.25 2.25 0 00-2.25 2.25V18A2.25 2.25 0 006 20.25zm9.75-9.75H18a2.25 2.25 0 002.25-2.25V6A2.25 2.25 0 0018 3.75h-2.25A2.25 2.25 0 0013.5 6v2.25a2.25 2.25 0 002.25 2.25z" />
                </svg>
              </div>
              <div class="flex-auto">
                <a href="/integration" class="block font-semibold text-gray-900">
                  Integrations
                  <span class="absolute inset-0"></span>
                </a>
